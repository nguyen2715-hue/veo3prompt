...
export const SpreadsheetIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-8.25V15M3 8.25h18M3 12h18m-9 8.25h9.75A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25H9" />
    </svg>
);
...
export const SettingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.113-1.113l.448-.112a2.25 2.25 0 012.13 0l.448.112c.553.106 1.023.571 1.113 1.113l.064.384a2.25 2.25 0 003.494 1.286l.33-.205a2.25 2.25 0 012.53 1.043l.242.419a2.25 2.25 0 01-1.043 2.53l-.205.329a2.25 2.25 0 00-1.286 3.494l.384.064c.542.09.967.56 1.113 1.113l.112.448a2.25 2.25 0 010 2.13l-.112.448c-.106.553-.571 1.023-1.113 1.113l-.384.064a2.25 2.25 0 00-1.286 3.494l.205.33a2.25 2.25 0 01-1.043 2.53l-.419.242a2.25 2.25 0 01-2.53-1.043l-.329-.205a2.25 2.25 0 00-3.494-1.286l-.064-.384c-.09-.542-.56-1.007-1.113-1.113l-.448-.112a2.25 2.25 0 01-2.13 0l-.448.112c-.553-.106-1.023-.571-1.113-1.113l-.064-.384a2.25 2.25 0 00-3.494-1.286l-.33.205a2.25 2.25 0 01-2.53-1.043l-.242-.419a2.25 2.25 0 011.043-2.53l.205-.329a2.25 2.25 0 001.286-3.494l-.384-.064c-.542-.09-.967.56-1.113-1.113l-.112-.448a2.25 2.25 0 010-2.13l.112-.448c.106-.553.571 1.023 1.113-1.113l.384-.064a2.25 2.25 0 001.286-3.494l-.205-.33a2.25 2.25 0 011.043-2.53l.419-.242a2.25 2.25 0 012.53 1.043l.329.205a2.25 2.25 0 003.494 1.286l.064.384z" />
...
export const ViewfinderIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5M6 13.5h12M6 13.5a2.25 2.25 0 01-2.25-2.25V9a2.25 2.25 0 012.25-2.25M18 13.5a2.25 2.25 0 002.25-2.25V9A2.25 2.25 0 0018 6.75" />
    </svg>
);
